				...
				<form ng-submit="ctrl.submit()" name="myForm"
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<input type="text" ng-model="ctrl.employee.name" name="uname"
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<input type="text" ng-model="ctrl.employee.salary"
					...
					<div class="row">
						<div class="form-group col-md-12">
							...
							<div class="col-md-7">
								<input type="email" ng-model="ctrl.employee.ssn" name="email"
...
<script type="text/javascript"
	src="<c:url value='resources/js/service/user_service.js'/>"></script>
<script type="text/javascript"
